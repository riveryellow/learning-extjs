 ...
 * 
 * @license Ext.ux.PagingToolbarResizer is licensed under the terms of the Open
 ...
 * How to use
 * 
 * Just instatiate a new PagingToolbarResizer inside PagingToolbar plugins
 * option:
 * 
 ...
 * display", plugins : [Ext.create('Ext.ux.PagingToolbarResizer', {options : [
 * 50, 100, 500 ] })] })
 */
Ext.define('Ext.ux.PagingToolbarResizer', {
	 ...
	 */
    displayText: '每页显示条数',// TODO 此处没实现国际化[liuxing]
